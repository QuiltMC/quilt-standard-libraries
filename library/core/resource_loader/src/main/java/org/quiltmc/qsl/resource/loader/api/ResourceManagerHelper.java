...
import org.quiltmc.qsl.resource.loader.impl.ResourceManagerHelperImpl;
...
public interface ResourceManagerHelper {
	 ...
	 * @deprecated Use {@link ResourceManagerHelper#registerReloadListener(IdentifiableResourceReloader)}
	 */
	@Deprecated
	default void addReloadListener(IdentifiableResourceReloader listener) {
	 ...
	 * @param listener The resource reload listener.
	 */
	void registerReloadListener(IdentifiableResourceReloader listener);
