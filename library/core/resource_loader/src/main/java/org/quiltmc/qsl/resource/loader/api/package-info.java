 ...
 *  <li>Virtual Pack refers to a resource pack that may be generated at runtime, or simply doesn't exist directly on
 *  disk.</li>
 ...
 * The Resource Loader will create a resource pack for each mod that provides resources in {@code assets} or
 * {@code data} top-level directories of the mod.
 ...
 * which may be used to add new resource packs that are visible to the player in the resource pack selection screens or
 * the {@code datapack} command.
 *
 ...
 *         - an event to register resource packs that are on the top of the resource pack hierarchy, those resource
 *         packs are invisible to the player.
 *     </li>
 *     <li>{@link org.quiltmc.qsl.resource.loader.api.InMemoryPack} - a resource pack implementation whose resources are
 *     stored in the live memory.</li>
 *     <li>
 *         {@link org.quiltmc.qsl.resource.loader.api.GroupPack} - a resource pack implementation which can be used to
 *         group multiple resource packs into one.
 *     </li>
 * </ul>
 *
 ...
 *
 * <p>The currently supported targets are:
 * <ul>
 *     <li>
 ...
 * </ul>
 *
 * <p>Do note that this won't allow for overriding resources that the built-in resource packs already have.
 *
 * <p>In the case of data-packs, Vanilla has a {@code data/minecraft/datapacks} directory in which folders for each
 ...
 * vanilla resource reloader identifiers may be found in
 * {@link org.quiltmc.qsl.resource.loader.api.reloader.ResourceReloaderKeys}.
 */
