 ...
 * sub-directories.
 * Those mod resource packs are grouped into the default resource pack, they can override the default resource pack but unrecommended.</p>
 *
 ...
 * {@link org.quiltmc.qsl.resource.loader.api.ResourceLoader#registerBuiltinResourcePack(net.minecraft.util.Identifier, net.fabricmc.loader.api.ModContainer, ResourcePackActivationType)}</p>
 *
 ...
 *
 * <p><h3>Resource Reloaders</h3></p>
 * <p>The Resource Loader allows mods to register resource reloaders through
 ...
 * A resource reloader can depend on another and vanilla resource reloader identifiers may be found in {@link org.quiltmc.qsl.resource.loader.api.reloader.ResourceReloaderKeys}.</p>
 */
