 ...
 *
 * <p>The {@link net.minecraft.client.MinecraftClient#getInstance() Minecraft client singleton} may be accessed at any
 * time during mod initialization, however the singleton will be in an incomplete state during mod initialization.
