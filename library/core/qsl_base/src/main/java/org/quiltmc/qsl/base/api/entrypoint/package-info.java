 ...
 *
 * <p>The Quilt Base API module provides three basic general-purpose entrypoints for mods:
 * <ul>
 ...
 *     <li>{@linkplain org.quiltmc.qsl.base.api.entrypoint.client.ClientModInitializer ClientModInitializer},
 *     a client-side mod initializer.</li>
 ...
 * </ul>
 *
 * <p>The Quilt Base API module also provides three event-based entrypoints for mods,
 * which some events may support by implementing any of the following interfaces:
 * <ul>
 *     <li>{@linkplain org.quiltmc.qsl.base.api.event.EventAwareListener EventAwareListener}, marks an event callback as
 *     usable as an entrypoint.</li>
 ...
 * </ul>
 *
 * <p>More entrypoints may be defined by other QSL modules.
 *
