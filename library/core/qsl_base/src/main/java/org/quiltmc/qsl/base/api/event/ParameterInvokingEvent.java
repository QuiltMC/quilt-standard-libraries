 ...
 *
 * <p>A good reason to make an event parameter invoking is when the event directly relates to an action performed on a
 ...
 *
 * <p>An event which may invoke a parameter should first place the annotation on the field of the event instance or the
