...
public final class ToolManagerImpl {
	private static final Map<Tag<Item>, Tag<Block>> MINEABLE_TAG_BY_TOOL = ImmutableMap.<Tag<Item>, Tag<Block>>builder()
			...
			.put(QuiltToolTags.AXES, BlockTags.AXE_MINEABLE)
			.put(QuiltToolTags.HOES, BlockTags.HOE_MINEABLE)
			.put(QuiltToolTags.PICKAXES, BlockTags.PICKAXE_MINEABLE)
			.put(QuiltToolTags.SHOVELS, BlockTags.SHOVEL_MINEABLE)
			// Quilt mineable tags
			.put(QuiltToolTags.SHEARS, QuiltMineableTags.SHEARS_MINEABLE)
			.put(QuiltToolTags.SWORDS, QuiltMineableTags.SWORD_MINEABLE)
			.build();
	...
	private static final Event<ToolHandler> GENERAL_TOOLS_HANDLER = Event.create(ToolHandler.class, ToolManagerImpl::toolHandlerInvoker);
	...
	public static Event<ToolHandler> tag(Tag<Item> tag) {
		...
		HANDLER_MAP.put(tag, Event.create(ToolHandler.class, ToolManagerImpl::toolHandlerInvoker));
	 ...
	 *
	 * @see org.quiltmc.qsl.tool_attributes.impl.ToolHandlers for the default handlers.
	 */
