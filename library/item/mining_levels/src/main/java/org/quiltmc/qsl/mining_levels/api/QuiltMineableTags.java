...
package org.quiltmc.qsl.mining_levels.api;
 ...
 * Fabric API defines two additional {@code mineable} tags: {@link #SWORD_MINEABLE #quilt:mineable/sword}
 * and {@link #SHEARS_MINEABLE #quilt:mineable/shears}.
 */
public class QuiltMineableTags {
	/**
	 * Blocks in this tag ({@code #quilt:mineable/sword}) can be effectively mined with swords
	 *
	...
	/**
	 * Blocks in this tag ({@code #quilt:mineable/shears}) can be effectively mined with shears.
	 */
