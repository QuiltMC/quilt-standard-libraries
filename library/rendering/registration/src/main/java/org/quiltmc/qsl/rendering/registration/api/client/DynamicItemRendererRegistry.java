...
/**
 * This registry holds {@linkplain DynamicItemRenderer dynamic item renderers} for items.
 */
@Environment(EnvType.CLIENT)
public final class DynamicItemRendererRegistry {
	private DynamicItemRendererRegistry() {
	}
