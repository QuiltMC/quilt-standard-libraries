...
import org.quiltmc.qsl.rendering.item.test.StorageItem;

@Environment(EnvType.CLIENT)
public class EnergyItemBarRenderer extends SolidColorItemBarRenderer {
	public static final ItemBarRenderer INSTANCE = new EnergyItemBarRenderer();
