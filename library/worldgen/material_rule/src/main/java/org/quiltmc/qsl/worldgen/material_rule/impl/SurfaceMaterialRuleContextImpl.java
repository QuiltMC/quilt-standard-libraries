...
@ApiStatus.Internal
public class SurfaceMaterialRuleContextImpl implements SurfaceMaterialRuleContext, SurfaceMaterialRuleContext.Nether, SurfaceMaterialRuleContext.TheEnd {
	private final SurfaceRules.SequenceMaterialRule sequenceRule;

	public SurfaceMaterialRuleContextImpl(SurfaceRules.MaterialRule rules) {
	...
	@ApiStatus.Internal
	public static class OverworldImpl extends SurfaceMaterialRuleContextImpl implements SurfaceMaterialRuleContext.Overworld {
