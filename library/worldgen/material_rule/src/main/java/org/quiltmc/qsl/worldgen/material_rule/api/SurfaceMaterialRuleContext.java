...
/**
 * Represents a context about surface material rules for ease of modification of them.
 *
 * @see SurfaceMaterialRuleEvents
 */
public interface SurfaceMaterialRuleContext {
	/**
	 ...
	 */
	interface Overworld extends SurfaceMaterialRuleContext {
		/**
	 ...
	 */
	interface Nether extends SurfaceMaterialRuleContext {
	}

	/**
	 * Represents the End-specific context.
	 */
	interface TheEnd extends SurfaceMaterialRuleContext {
	}
}
