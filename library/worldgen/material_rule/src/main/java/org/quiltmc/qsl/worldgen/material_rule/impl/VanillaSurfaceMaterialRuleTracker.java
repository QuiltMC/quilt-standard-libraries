...
@ApiStatus.Internal
public final class VanillaSurfaceMaterialRuleTracker<T extends SurfaceMaterialRuleContextImpl> {
	public static final VanillaSurfaceMaterialRuleTracker<SurfaceMaterialRuleContextImpl.OverworldImpl> OVERWORLD =
			new VanillaSurfaceMaterialRuleTracker<>(context -> SurfaceMaterialRuleEvents.MODIFY_OVERWORLD.invoker().modifyOverworldRules(context));
	public static final VanillaSurfaceMaterialRuleTracker<SurfaceMaterialRuleContextImpl> NETHER = new VanillaSurfaceMaterialRuleTracker<>(
			context -> SurfaceMaterialRuleEvents.MODIFY_NETHER.invoker().modifyNetherRules(context)
	);
	public static final VanillaSurfaceMaterialRuleTracker<SurfaceMaterialRuleContextImpl> THE_END = new VanillaSurfaceMaterialRuleTracker<>(
			context -> SurfaceMaterialRuleEvents.MODIFY_THE_END.invoker().modifyTheEndRules(context)
	);

	private final Consumer<T> eventInvoker;
	private List<T> rules = new ArrayList<>();

	private VanillaSurfaceMaterialRuleTracker(Consumer<T> eventInvoker) {
