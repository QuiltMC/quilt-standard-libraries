...
public class BiomeSelectionContextImpl implements BiomeSelectionContext {
	...
	@Override
	public boolean validForStructure(RegistryKey<class_3195> key) {
		class_3195 instance = this.dynamicRegistries.get(Registry.STRUCTURE_WORLDGEN).get(key);
	...
	@Override
	public Optional<RegistryKey<class_3195>> getStructureKey(class_3195 configuredStructure) {
		Registry<class_3195> registry = this.dynamicRegistries.get(Registry.STRUCTURE_WORLDGEN);
