...
package org.quiltmc.qsl.villagers.api.villager_type;
...
import org.quiltmc.qsl.villagers.mixin.VillagerProfessionAccessor;
...
public final class VillagerProfessionBuilder {
	...
	/**
	 * A collection of blocks which may suffice as a secondary job site for a Villager.
	 *
	 ...
	 * A collection of blocks which may suffice as a secondary job site for a Villager.
	 *
	 * <p>In Vanilla, this is used by the {@link VillagerProfession#FARMER Farmer} to stay near {@link Blocks#FARMLAND Farmland} when at its job site.
	 *
	 * @param blocks Collection of secondary job site blocks.
	 * @return this builder.
	 */
