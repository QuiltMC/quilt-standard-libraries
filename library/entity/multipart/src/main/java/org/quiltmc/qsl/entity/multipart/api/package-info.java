 ...
 *
 * <p>This API abstracts many of the previously {@link net.minecraft.entity.boss.dragon.EnderDragonEntity EnderDragon}
 * and {@link net.minecraft.entity.boss.dragon.EnderDragonPart EnderDragonPart}
 * specific code so that modders can implement their own
 * {@link org.quiltmc.qsl.entity.multipart.api.MultipartEntity MultipartEntities}.
 *
 ...
 * {@link org.quiltmc.qsl.entity.multipart.api.MultipartEntity#qsl$getEntityParts() getEntityParts()}. Then, each of its
 * parts must be an instance of {@link org.quiltmc.qsl.entity.multipart.api.EntityPart EntityPart}.
 ...
 * }}</pre>
 *
 * <p>This API also fixes two vanilla bugs:
 * <ul>
