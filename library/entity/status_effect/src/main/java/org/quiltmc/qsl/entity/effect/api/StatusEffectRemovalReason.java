...
public class StatusEffectRemovalReason {
	 ...
	 *
	 * <p>Cannot be cancelled (
	 * {@link StatusEffect#shouldRemove(LivingEntity, StatusEffectInstance, StatusEffectRemovalReason)}
	 * is not called for this reason).
	 */
	public static final StatusEffectRemovalReason EXPIRED =
			new StatusEffectRemovalReason(QuiltStatusEffectInternals.id("expired"));
	 ...
	 * is not called for this reason).
	 */
	public static final StatusEffectRemovalReason UPGRADE_REAPPLYING =
			new StatusEffectRemovalReason(QuiltStatusEffectInternals.id("upgrade.reapplying"));

	/**
	 * Used when effects are removed via the vanilla {@link LivingEntity#clearStatusEffects()} method.
	 */
	public static final StatusEffectRemovalReason GENERIC_ALL =
			new StatusEffectRemovalReason(QuiltStatusEffectInternals.id("generic.all"));
	 ...
	 */
	public static final StatusEffectRemovalReason GENERIC_ONE =
			new StatusEffectRemovalReason(QuiltStatusEffectInternals.id("generic.one"));

	/**
	 * Used when effects are removed via the {@code /effect clear} command.
	 */
	public static final StatusEffectRemovalReason COMMAND_ALL =
			new StatusEffectRemovalReason(QuiltStatusEffectInternals.id("command.all"));

	/**
	 * Used when an effect is removed via the {@code /effect remove} command.
	 */
	public static final StatusEffectRemovalReason COMMAND_ONE =
	 ...
	 *
	 * <p>Override this, for example, to make a status effect remover that only removes
