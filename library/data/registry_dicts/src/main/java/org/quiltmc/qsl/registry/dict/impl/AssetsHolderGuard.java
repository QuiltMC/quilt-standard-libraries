 ...
 * {@linkplain RegistryDictHolder#getAssets(Registry) assets-based <code>RegistryDictHolder</code> instance}
...
public final class AssetsHolderGuard {
	...
	public static void assertAccessAllowed() {
		if (!allowed) {
			throw new IllegalStateException("Access to assets-based registry dicts is not allowed here!");
		}
	}
}
