...
public enum TagType {
	 ...
	 *
	 * <p>The client does not provide a default.
	 */
	NORMAL,
	/**
	 ...
	 *
	 * <p>A {@link net.minecraft.registry.tag.TagKey} with this type will be considered different from
	 ...
	 *
	 * <p>Those tags are not present on the server, thus no syncing will happen.
	 *
	 * <p>A {@link net.minecraft.registry.tag.TagKey} with this type will be considered entirely different from
	 * a {@link net.minecraft.registry.tag.TagKey} with any of the other types even if they both share the same
	 * identifier, which means both keys won't link to the same tag content, client tag content will not leak into other
	 * tags, and vice-versa.
	 */
	CLIENT_ONLY;
