...
public final class VanillaRecipeBuilders {
	 ...
	 */
	public static RecipeUnlocker<SmeltingRecipe> smeltingRecipe(Identifier id, String group, Ingredient input, CookingCategory category, ItemStack output,
	 ...
	 */
	public static RecipeUnlocker<BlastingRecipe> blastingRecipe(Identifier id, String group, Ingredient input, CookingCategory category, ItemStack output,
			float experience, int cookTime) {
	 ...
	 */
	public static RecipeUnlocker<SmokingRecipe> smokingRecipe(Identifier id, String group, CookingCategory category, Ingredient input,
