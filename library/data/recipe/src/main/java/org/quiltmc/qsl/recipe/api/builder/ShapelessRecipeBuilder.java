...
public class ShapelessRecipeBuilder extends RecipeBuilder<ShapelessRecipeBuilder, ShapelessRecipe> {
	 ...
	 */
	public RecipeUnlocker<ShapelessRecipe> build(Identifier id, String group) {
		...
		return new RecipeUnlocker<>(id, new ShapelessRecipe(group, this.category, this.output, ingredients));
	}
}
