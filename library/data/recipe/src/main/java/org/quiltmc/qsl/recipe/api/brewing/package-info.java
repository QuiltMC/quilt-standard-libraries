 ...
 *     <li>{@link org.quiltmc.qsl.recipe.api.brewing.PotionBrewingRecipe PotionBrewingRecipe}</li>
 ...
 * <p>
 * <h3>{@link org.quiltmc.qsl.recipe.api.brewing.PotionBrewingRecipe PotionBrewingRecipe}</h3>
 ...
 * This recipe is an extension of the {@link org.quiltmc.qsl.recipe.api.brewing.PotionBrewingRecipe PotionBrewingRecipe},
 * with added support for custom potion effects. Custom potion effects can be added through the {@code "effects"} entry.
 * Each entry is either a valid {@link net.minecraft.util.Identifier identifier} for a {@link net.minecraft.entity.effect.StatusEffect status effect} or a JSON object of the form:</li>
 * <ul>
 ...
 * </ul>
 * <p>
 * Recipes can also be built at runtime via the {@link org.quiltmc.qsl.recipe.api.builder.QuiltRecipeBuilders QuiltRecipeBuilders} and the {@link org.quiltmc.qsl.recipe.api Recipe API}.
 */
