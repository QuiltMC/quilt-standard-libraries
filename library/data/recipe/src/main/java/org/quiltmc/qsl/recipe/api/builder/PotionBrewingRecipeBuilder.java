 ...
 */
public class PotionBrewingRecipeBuilder extends AbstractPotionBrewingRecipeBuilder<PotionBrewingRecipeBuilder, Potion, PotionBrewingRecipe> {
	 ...
	 */
	public PotionBrewingRecipeBuilder(Potion input, Potion output) {
		super(input, output);
	}
