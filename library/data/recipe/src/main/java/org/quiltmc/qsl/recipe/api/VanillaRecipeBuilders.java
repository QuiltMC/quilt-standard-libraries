...
public final class VanillaRecipeBuilders {
	 ...
	 */
	public static abstract class Builder<Self extends Builder<Self, Result>, Result extends Recipe<?>> {
	 ...
	 */
	public static final class ShapedRecipeBuilder extends Builder<ShapedRecipeBuilder, ShapedRecipe> {
	...
	public static final class ShapelessRecipeBuilder extends Builder<ShapelessRecipeBuilder, ShapelessRecipe> {
