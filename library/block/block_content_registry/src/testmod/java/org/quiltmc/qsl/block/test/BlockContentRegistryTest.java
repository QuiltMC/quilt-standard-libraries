...
public class BlockContentRegistryTest implements ModInitializer {
	...
	public void onInitialize(ModContainer mod) {
		...
		BlockContentRegistries.ENCHANTMENT_POWER_LEVEL.put(Blocks.IRON_BLOCK, 3f);
		BlockContentRegistries.ENCHANTMENT_POWER_LEVEL.put(Blocks.DIAMOND_BLOCK, 15f);
		BlockContentRegistries.ENCHANTMENT_POWER_LEVEL.put(Blocks.NETHERITE_BLOCK, 100f);
		BlockContentRegistries.ENCHANTMENT_POWER_LEVEL.put(Blocks.OAK_PLANKS, 0.25f);
