...
public class BlockContentRegistryTest implements ModInitializer {
	...
	public void onInitialize(ModContainer mod) {
		...
		BlockContentRegistries.ENCHANTMENT_BOOSTER.put(Blocks.IRON_BLOCK, 3f);
		BlockContentRegistries.ENCHANTMENT_BOOSTER.put(Blocks.DIAMOND_BLOCK, 15f);
		BlockContentRegistries.ENCHANTMENT_BOOSTER.put(Blocks.NETHERITE_BLOCK, 100f);
		BlockContentRegistries.ENCHANTMENT_BOOSTER.put(Blocks.OAK_PLANKS, 0.25f);
