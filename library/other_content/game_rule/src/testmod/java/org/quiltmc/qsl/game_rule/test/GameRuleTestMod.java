...
package org.quiltmc.qsl.game_rule.test;
...
import org.quiltmc.qsl.game_rule.api.GameRuleFactory;
...
public class GameRuleTestMod implements ModInitializer {
	private static final Logger LOGGER = LogManager.getLogger(GameRuleTestMod.class);
	...
	public static final CustomGameRuleCategory GREEN_CATEGORY = new CustomGameRuleCategory(new Identifier("quilt", "green"), new LiteralText("This One is Green").styled(style -> style.withBold(true).withColor(Formatting.DARK_GREEN)));
	public static final CustomGameRuleCategory RED_CATEGORY = new CustomGameRuleCategory(new Identifier("quilt", "red"), new LiteralText("This One is Red").styled(style -> style.withBold(true).withColor(Formatting.DARK_RED)));
